...
ENDPOINTS=(
  ...
  "psk_reporter|fetchPSKReporter.pl?ofgrid=FN30&maxage=3600|1"
  "wspr.live|fetchWSPR.pl?maxage=3600|1"
  "rbn|fetchRBN.pl?ofgrid=FN30&maxage=3600|1"
  ...
  "lightning|lightning/strikes.pl|1"
  "balloons|balloons/balloons.txt|0"
)
